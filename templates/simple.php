...
//$lcp_display_output .= '<ul class="lcp_catlist" style="background-color: #f6f7ec; line-height: 1.3; padding: 7px 12px;">';
$lcp_display_output .= '<ul class="lcp_catlist" style="background-color: #F7F7F1; line-height: 1.3; padding: 7px 12px;">';
...
foreach ($this->catlist->get_categories_posts() as $single):
    ...
    $lcp_display_output .= '<li class="lcp_catlist_item" style="list-style: none; padding: 0 0 12px;">';

    //Show the title and link to the post:
	//$lcp_display_output .= '<div class="lcp_catlist_title" style="display: inline;">';
     ...
     */
 	...
 	$lcp_display_output .= '<div class="lcp_excerpt" style="color: #93938d; font-size: small; font-style: italic; display: inline; ">';
